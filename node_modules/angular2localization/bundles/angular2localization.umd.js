(function (global, factory) {
    ...
    (factory((global.ng = global.ng || {}, global.ng.angular2localization = global.ng.angular2localization || {}),global.ng.core,global.ng.http,global.Rx,global.Rx,global.Rx,global.ng.common,global.ng.forms));
...
var Locale = (function () {
     ...
     */
    function Locale(locale, localization, changeDetectorRef) {
        var _this = this;
        this.locale = locale;
...
var LocaleDirective = (function () {
    ...
    LocaleDirective.prototype.ngAfterViewInit = function () {
        ...
        var /** @type {?} */ nodeValue = (renderNode.nodeValue);
        var /** @type {?} */ value = nodeValue.trim();
        this.localize(renderNode, nodeValue, value);
        this.locale.defaultLocaleChanged.subscribe(function () {
            _this.localize(renderNode, nodeValue, value);
        });
    };
    /**
     * @abstract
...
var TranslateDirective = (function () {
     ...
     * @return {?}
     */
    TranslateDirective.prototype.translate = function (renderNode, nodeValue, key) {
        var _this = this;
        this.localization.translateAsync(key, this.params).subscribe(function (value) {
            _this.renderer.setText(renderNode, nodeValue.replace(key, value));
        });
    };
...
var LocaleDateDirective = (function (_super) {
     ...
     * @return {?}
     */
    LocaleDateDirective.prototype.localize = function (renderNode, nodeValue, value) {
...
var LocaleDecimalDirective = (function (_super) {
     ...
     * @return {?}
     */
    LocaleDecimalDirective.prototype.localize = function (renderNode, nodeValue, value) {
        var /** @type {?} */ defaultLocale = this.locale.getDefaultLocale();
        // Checks for support for Intl.
        if (IntlSupport.NumberFormat(defaultLocale) == true) {
            var /** @type {?} */ localeDecimal = new _angular_common.DecimalPipe(defaultLocale);
...
var LocalePercentDirective = (function (_super) {
     ...
     * @return {?}
     */
    LocalePercentDirective.prototype.localize = function (renderNode, nodeValue, value) {
        var /** @type {?} */ defaultLocale = this.locale.getDefaultLocale();
        // Checks for support for Intl.
        if (IntlSupport.NumberFormat(defaultLocale) == true) {
            var /** @type {?} */ localePercent = new _angular_common.PercentPipe(defaultLocale);
...
var LocaleCurrencyDirective = (function (_super) {
     ...
     * @return {?}
     */
    LocaleCurrencyDirective.prototype.localize = function (renderNode, nodeValue, value) {
        var /** @type {?} */ defaultLocale = this.locale.getDefaultLocale();
